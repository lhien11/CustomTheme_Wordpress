...
<div class="site-content clearfix">
    ...
    <div class="home-columns clearfix">
        ...
        <div class="one-half">
            ...
            $opinionPosts = new WP_Query('cat=2&posts_per_page=2');
           ...
           <span class="horiz-center"><a href="<?php echo get_category_link(2); ?>" class="btn-a">View all Blog Posts</a></span>
           
        </div>
        
        <div class="one-half last">
 
            <h2>Latest Miscellaneous</h2>
           ...
           <span class="horiz-center"><a href="<?php echo get_category_link(3); ?>" class="btn-a">View all Miscellaneous Posts</a></span>
